...
export async function saveProject(id: string | null, raw: unknown): Promise<SaveProjectResult> {
...
export async function togglePublished(id: string, slug: string, published: boolean): Promise<void> {
  const supabase = await requireAdmin();
