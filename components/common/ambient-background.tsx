    ...
    >
      ...
      >
        ...
        <g fill="rgb(var(--ink-rgb) / 0.3)">
          <circle cx={120} cy={150} r={4} className="animate-node-pulse [animation-delay:0s]" />
          <circle cx={360} cy={300} r={5} className="animate-node-pulse [animation-delay:0.9s]" />
          <circle cx={640} cy={210} r={4} className="animate-node-pulse [animation-delay:1.7s]" />
          <circle cx={900} cy={340} r={5} className="animate-node-pulse [animation-delay:2.4s]" />
          <circle cx={300} cy={560} r={4} className="animate-node-pulse [animation-delay:3.1s]" />
          <circle cx={640} cy={520} r={5} className="animate-node-pulse [animation-delay:3.9s]" />
          <circle cx={1080} cy={600} r={4} className="animate-node-pulse [animation-delay:4.6s]" />
          <circle cx={740} cy={700} r={4} className="animate-node-pulse [animation-delay:5.3s]" />
          <circle cx={520} cy={40} r={3} className="animate-node-pulse [animation-delay:6s]" />
        </g>
      </svg>
      <div
        ref={ruleRef}
