...
const CODE_LINES: React.ReactNode[] = [
  <Fragment key="fn">
    <span className="text-accent">function</span> <span className="text-ink/70">buildApp</span>
    <span className="text-faint">() {"{"}</span>
  </Fragment>,
  <Fragment key="ui">
    <span className="text-faint">  </span>
    <span className="text-accent">const</span> <span className="text-ink/70">ui</span>{" "}
    <span className="text-faint">=</span> <span className="text-ink/70">render</span>
    <span className="text-faint">(</span>
  ...
  <Fragment key="api">
    <span className="text-faint">  </span>
    <span className="text-accent">const</span> <span className="text-ink/70">api</span>{" "}
    <span className="text-faint">=</span> <span className="text-ink/70">connect</span>
    <span className="text-faint">(</span>
  ...
  <Fragment key="mount">
    <span className="text-faint">  </span>
    <span className="text-accent">return</span> <span className="text-ink/70">ui</span>
    <span className="text-faint">.</span>
...
export function ServiceBuild() {
  ...
  const step = (hidden: string, delay: number, duration = 850): CSSProperties => {
  ...
  return (
    ...
    >
      <div
        ...
        style={{ transitionTimingFunction: EASE, opacity: play || reduced ? 1 : 0 }}
      />
      ...
      >
        ...
        >
          ...
          <g style={step("translate(6px,4px) scale(0.7)", 1050, 700)}>
            ...
            />
            <line x1="91" y1="56.2" x2="98.2" y2="56.2" stroke="var(--accent)" strokeWidth="0.5" opacity="0.6" />
            <line x1="91" y1="59.3" x2="98.2" y2="59.3" stroke="var(--accent)" strokeWidth="0.5" opacity="0.6" />
          </g>
        </svg>
        ...
        >
          ...
          >
            ...
            <div className={`${faceClass} bg-card`} style={{ transform: "translateZ(1px)" }}>
              ...
              <div className="flex items-center gap-[6%] px-[6%] pt-[6%]" style={step("translateY(-10px)", 300, 650)}>
              ...
              <div className="grid grid-cols-2 gap-[6%] px-[6%] pt-[9%]">
                <div className="flex flex-col gap-[12%]" style={step("translateX(-18px)", 420, 700)}>
            ...
            <div className={`${faceClass} flex flex-col bg-card-2`} style={{ transform: "rotateY(180deg) translateZ(1px)" }}>
              <div className="flex items-center gap-[5px] border-b border-ink/10 px-[6%] py-[4.5%]">
                <span className="h-[7px] w-[7px] flex-none rounded-full bg-ink/15" />
                <span className="h-[7px] w-[7px] flex-none rounded-full bg-ink/15" />
                <span className="h-[7px] w-[7px] flex-none rounded-full bg-ink/15" />
